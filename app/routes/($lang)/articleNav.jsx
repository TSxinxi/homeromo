            ...
            id == 0 ? <div className="shopify-policy__container">
              ...
              <div className="shopify-policy__body">
                <div className="rte">
                  ...
                  <div style={{ textAlign: "center" }}>Prin furnizarea datelor dvs. personale, sunteți de acord ca homeromo.com să utilizeze datele colectate pentru a ne îndeplini obligațiile față de dvs. și pentru a vă oferi serviciile la care v-ați așteptat.</div>
                  <div style={{ textAlign: "center" }}><br /></div>
                  <div style={{ textAlign: "center" }}>Avem nevoie de datele dumneavoastră personale în următoarele scopuri:</div>
                  <div style={{ textAlign: "center" }}><br /></div>
                  <div style={{ textAlign: "center" }}>- Creați-vă contul personal pe homeromo.com (de exemplu, numele și adresa dvs. de e-mail)</div>
                  <div style={{ textAlign: "center" }}><br /></div>
                ...
                <div className="shopify-policy__body">
                  <div className="rte">
                    ...
                    <div style={{ textAlign: "center" }}>- tă rugăm să ne informați despre intenția dumneavoastră de a returna numărul comenzii, detaliile articolului returnat, o fotografie a articolului și numărul contului bancar de rambursare la
                      ...
                      <p><strong>cddfiistq@<a href="https://outlook.com/" target="_blank">outlook.com</a></strong></p>
